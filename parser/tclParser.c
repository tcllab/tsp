 ...
 */
 ...
 /* i686-w64-mingw32-gcc -shared -s -m32 -D_WIN32 -Iincludetcl -Iincludetcl/win -Iinclude/xlib ./tclParser.c -Llib -ltclstub86 -Llib  -otclparser.dll */
...
static char packageVersion[] = "1.001";
